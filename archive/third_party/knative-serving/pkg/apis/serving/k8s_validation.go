...
import (
	...
	"github.com/google/kf/third_party/knative-serving/pkg/apis/networking"
...
var (
	...
	// allowed.
	// https://github.com/google/kf/third_party/knative-serving//blob/master/docs/runtime-contract.md#inbound-network-connectivity
