...
func Get(ctx context.Context) v1beta1.ServiceInstanceInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Fatalf(
			"Unable to fetch %T from context.", (v1beta1.ServiceInstanceInformer)(nil))
	}
	return untyped.(v1beta1.ServiceInstanceInformer)
}
