...
var sourcesResource = schema.GroupVersionResource{Group: "kf.dev", Version: "v1alpha1", Resource: "sources"}

var sourcesKind = schema.GroupVersionKind{Group: "kf.dev", Version: "v1alpha1", Kind: "Source"}
...
func (c *FakeSources) UpdateStatus(source *v1alpha1.Source) (*v1alpha1.Source, error) {
	obj, err := c.Fake.
