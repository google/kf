...
var appsResource = schema.GroupVersionResource{Group: "kf.dev", Version: "v1alpha1", Resource: "apps"}

var appsKind = schema.GroupVersionKind{Group: "kf.dev", Version: "v1alpha1", Kind: "App"}
