...
// Source: github.com/google/kf/pkg/kf/service-brokers/namespaced/fake (interfaces: Client)
...
import (
	...
	namespaced "github.com/google/kf/pkg/kf/service-brokers/namespaced"
...
func (m *FakeClient) Create(arg0 string, arg1 *v1beta1.ServiceBroker, arg2 ...namespaced.CreateOption) (*v1beta1.ServiceBroker, error) {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(*v1beta1.ServiceBroker)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *FakeClient) Delete(arg0, arg1 string, arg2 ...namespaced.DeleteOption) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *FakeClient) Get(arg0, arg1 string, arg2 ...namespaced.GetOption) (*v1beta1.ServiceBroker, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *FakeClient) List(arg0 string, arg1 ...namespaced.ListOption) ([]v1beta1.ServiceBroker, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) Transform(arg0, arg1 string, arg2 namespaced.Mutator) (*v1beta1.ServiceBroker, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) Update(arg0 string, arg1 *v1beta1.ServiceBroker, arg2 ...namespaced.UpdateOption) (*v1beta1.ServiceBroker, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *FakeClient) Upsert(arg0 string, arg1 *v1beta1.ServiceBroker, arg2 namespaced.Merger) (*v1beta1.ServiceBroker, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) WaitFor(arg0 context.Context, arg1, arg2 string, arg3 time.Duration, arg4 namespaced.Predicate) (*v1beta1.ServiceBroker, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) WaitForConditionReadyTrue(arg0 context.Context, arg1, arg2 string, arg3 time.Duration) (*v1beta1.ServiceBroker, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) WaitForDeletion(arg0 context.Context, arg1, arg2 string, arg3 time.Duration) (*v1beta1.ServiceBroker, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) WaitForE(arg0 context.Context, arg1, arg2 string, arg3 time.Duration, arg4 namespaced.ConditionFuncE) (*v1beta1.ServiceBroker, error) {
	m.ctrl.T.Helper()
