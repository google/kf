...
var (
	flagCompletionFunctions     = map[*pflag.Flag]func(cmd *Command, args []string, toComplete string) ([]string, ShellCompDirective){}
	flagCompletionFunctionsSync sync.Mutex
)
...
func (c *Command) RegisterFlagCompletionFunc(flagName string, f func(cmd *Command, args []string, toComplete string) ([]string, ShellCompDirective)) error {
	flagCompletionFunctionsSync.Lock()
	defer flagCompletionFunctionsSync.Unlock()
