...
//
// See also: https://github.com/google/kf/third_party/knative-serving//blob/master/docs/spec/overview.md#revision
...
// See also: https://github.com/google/kf/third_party/knative-serving//blob/master/docs/spec/errors.md#error-conditions-and-reporting
...
const (
	...
	// Note: currently not set anywhere. See https://github.com/google/kf/third_party/knative-serving//issues/1203
...
type RevisionSpec struct {
	...
	//
	// Tracking issue: https://github.com/google/kf/third_party/knative-serving//issues/643
	//
	// +optional
	...
	// environment:
	// https://github.com/google/kf/third_party/knative-serving//blob/master/docs/runtime-contract.md
	// +optional
