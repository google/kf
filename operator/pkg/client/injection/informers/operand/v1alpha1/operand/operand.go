...
func Get(ctx context.Context) v1alpha1.OperandInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch kf-operator/pkg/client/informers/externalversions/operand/v1alpha1.OperandInformer from context.")
	}
