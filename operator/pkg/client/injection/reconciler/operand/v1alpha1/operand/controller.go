...
const (
	defaultControllerAgentName = "operand-controller"
	defaultFinalizerName       = "operands.operand.run.cloud.google.com"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	operandInformer := operand.Get(ctx)

	lister := operandInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "operand.run.cloud.google.com.Operand"),
	)
