...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1alpha1.Operand, desired *v1alpha1.Operand) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.Operand) (*v1alpha1.Operand, error) {
