...
import (
	context "context"
	fmt "fmt"
	versionedscheme "kf-operator/pkg/client/clientset/versioned/scheme"
...
const (
	defaultControllerAgentName = "clusteractiveoperand-controller"
	defaultFinalizerName       = "clusteractiveoperands.operand.run.cloud.google.com"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	clusteractiveoperandInformer := clusteractiveoperand.Get(ctx)

	lister := clusteractiveoperandInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "operand.run.cloud.google.com.ClusterActiveOperand"),
	)
