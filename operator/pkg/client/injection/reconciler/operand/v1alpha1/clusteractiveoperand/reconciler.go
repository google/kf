...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1alpha1.ClusterActiveOperand, desired *v1alpha1.ClusterActiveOperand) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.ClusterActiveOperand) (*v1alpha1.ClusterActiveOperand, error) {
