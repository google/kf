...
const (
	defaultControllerAgentName = "activeoperand-controller"
	defaultFinalizerName       = "activeoperands.operand.run.cloud.google.com"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	activeoperandInformer := activeoperand.Get(ctx)

	lister := activeoperandInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "operand.run.cloud.google.com.ActiveOperand"),
	)
