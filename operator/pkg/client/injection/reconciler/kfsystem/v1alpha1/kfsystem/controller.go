...
const (
	defaultControllerAgentName = "kfsystem-controller"
	defaultFinalizerName       = "kfsystems.kf.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	kfsystemInformer := kfsystem.Get(ctx)

	lister := kfsystemInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "kf.dev.KfSystem"),
	)
