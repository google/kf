---
title: "kf network-policy"
weight: 100
description: "Print information about the given NetworkPolicy."
---
### Name

<code translate="no">kf network-policy</code> - Print information about the given NetworkPolicy.

### Synopsis

<pre translate="no">kf network-policy NAME [flags]</pre>

### Examples

<pre translate="no">
kf network-policy my-network-policy</pre>
...
<dd><p>help for network-policy</p>
</dd>
