---
title: "kf network-policies"
weight: 100
description: "List network policies in the targeted Space."
---
### Name

<code translate="no">kf network-policies</code> - List network policies in the targeted Space.

### Synopsis

<pre translate="no">kf network-policies [flags]</pre>

### Examples

<pre translate="no">
kf network-policies</pre>
...
<dd><p>help for network-policies</p>
</dd>
