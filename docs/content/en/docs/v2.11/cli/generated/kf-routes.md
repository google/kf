...
title: "kf routes"
weight: 100
description: "List routes in the targeted Space."
---
### Name

<code translate="no">kf routes</code> - List routes in the targeted Space.

### Synopsis

<pre translate="no">kf routes [flags]</pre>
