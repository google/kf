...
title: "kf bindings"
weight: 100
description: "List bindings in the targeted Space."
---
### Name

<code translate="no">kf bindings</code> - List bindings in the targeted Space.

### Synopsis

<pre translate="no">kf bindings [flags]</pre>
