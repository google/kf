...
1. Create a sample deployment manifest. This snippet contains a minimally functional UAA configuration based on the manifest generated by running `gradlew manifests` in the UAA source repo. You should replace the `UAA_CONFIG_YAML` value with your own:
