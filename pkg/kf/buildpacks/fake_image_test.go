...
// FakeLayer is a mock of Layer interface
type FakeLayer struct {
	ctrl     *gomock.Controller
	recorder *FakeLayerMockRecorder
}

// FakeLayerMockRecorder is the mock recorder for FakeLayer
type FakeLayerMockRecorder struct {
	mock *FakeLayer
}

// NewFakeLayer creates a new mock instance
func NewFakeLayer(ctrl *gomock.Controller) *FakeLayer {
	mock := &FakeLayer{ctrl: ctrl}
	mock.recorder = &FakeLayerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *FakeLayer) EXPECT() *FakeLayerMockRecorder {
	return m.recorder
}

// Compressed mocks base method
func (m *FakeLayer) Compressed() (io.ReadCloser, error) {
	m.ctrl.T.Helper()
...
func (mr *FakeLayerMockRecorder) Compressed() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Compressed", reflect.TypeOf((*FakeLayer)(nil).Compressed))
}

// DiffID mocks base method
func (m *FakeLayer) DiffID() (v1.Hash, error) {
	m.ctrl.T.Helper()
...
func (mr *FakeLayerMockRecorder) DiffID() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DiffID", reflect.TypeOf((*FakeLayer)(nil).DiffID))
}

// Digest mocks base method
func (m *FakeLayer) Digest() (v1.Hash, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Digest")
	ret0, _ := ret[0].(v1.Hash)
	ret1, _ := ret[1].(error)
...
// Digest indicates an expected call of Digest
func (mr *FakeLayerMockRecorder) Digest() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Digest", reflect.TypeOf((*FakeLayer)(nil).Digest))
}

// Size mocks base method
func (m *FakeLayer) Size() (int64, error) {
	m.ctrl.T.Helper()
...
func (mr *FakeLayerMockRecorder) Size() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Size", reflect.TypeOf((*FakeLayer)(nil).Size))
}

// Uncompressed mocks base method
func (m *FakeLayer) Uncompressed() (io.ReadCloser, error) {
	m.ctrl.T.Helper()
...
func (mr *FakeLayerMockRecorder) Uncompressed() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Uncompressed", reflect.TypeOf((*FakeLayer)(nil).Uncompressed))
}
