...
// Predicate is a boolean function for a servicecatalogv1beta1.ServiceBroker.
type Predicate func(*servicecatalogv1beta1.ServiceBroker) bool

// AllPredicate is a predicate that passes if all children pass.
func AllPredicate(children ...Predicate) Predicate {
	return func(obj *servicecatalogv1beta1.ServiceBroker) bool {
...
// Mutator is a function that changes servicecatalogv1beta1.ServiceBroker.
type Mutator func(*servicecatalogv1beta1.ServiceBroker) error
...
func DiffWrapper(w io.Writer, mutator Mutator) Mutator {
	return func(mutable *servicecatalogv1beta1.ServiceBroker) error {
...
// FormatDiff creates a diff between two servicecatalogv1beta1.ServiceBrokers and writes it to the given
// writer.
func FormatDiff(w io.Writer, leftName, rightName string, left, right *servicecatalogv1beta1.ServiceBroker) {
...
// List represents a collection of servicecatalogv1beta1.ServiceBroker.
type List []servicecatalogv1beta1.ServiceBroker
...
func (list MutatorList) Apply(svc *servicecatalogv1beta1.ServiceBroker) error {
...
func LabelSetMutator(labels map[string]string) Mutator {
	return func(obj *servicecatalogv1beta1.ServiceBroker) error {
		if obj.Labels == nil {
...
// Client is the interface for interacting with servicecatalogv1beta1.ServiceBroker types as ServiceBroker CF style objects.
type Client interface {
	Create(namespace string, obj *servicecatalogv1beta1.ServiceBroker, opts ...CreateOption) (*servicecatalogv1beta1.ServiceBroker, error)
	Update(namespace string, obj *servicecatalogv1beta1.ServiceBroker, opts ...UpdateOption) (*servicecatalogv1beta1.ServiceBroker, error)
	Transform(namespace string, name string, transformer Mutator) error
	Get(namespace string, name string, opts ...GetOption) (*servicecatalogv1beta1.ServiceBroker, error)
	Delete(namespace string, name string, opts ...DeleteOption) error
	List(namespace string, opts ...ListOption) ([]servicecatalogv1beta1.ServiceBroker, error)
	Upsert(namespace string, newObj *servicecatalogv1beta1.ServiceBroker, merge Merger) (*servicecatalogv1beta1.ServiceBroker, error)
	WaitFor(ctx context.Context, namespace string, name string, interval time.Duration, condition Predicate) (*servicecatalogv1beta1.ServiceBroker, error)
	WaitForE(ctx context.Context, namespace string, name string, interval time.Duration, condition ConditionFuncE) (*servicecatalogv1beta1.ServiceBroker, error)
...
type coreClient struct {
	kclient servicecatalogclient.ServiceBrokersGetter

	upsertMutate        MutatorList
	membershipValidator Predicate
}

func (core *coreClient) preprocessUpsert(obj *servicecatalogv1beta1.ServiceBroker) error {
...
// Create inserts the given servicecatalogv1beta1.ServiceBroker into the cluster.
// The value to be inserted will be preprocessed and validated before being sent.
func (core *coreClient) Create(namespace string, obj *servicecatalogv1beta1.ServiceBroker, opts ...CreateOption) (*servicecatalogv1beta1.ServiceBroker, error) {
...
// The value to be inserted will be preprocessed and validated before being sent.
func (core *coreClient) Update(namespace string, obj *servicecatalogv1beta1.ServiceBroker, opts ...UpdateOption) (*servicecatalogv1beta1.ServiceBroker, error) {
	if err := core.preprocessUpsert(obj); err != nil {
		return nil, err
	}
...
func (core *coreClient) Get(namespace string, name string, opts ...GetOption) (*servicecatalogv1beta1.ServiceBroker, error) {
	...
	return nil, fmt.Errorf("an object with the name %s exists, but it doesn't appear to be a ServiceBroker", name)
}
...
func (core *coreClient) List(namespace string, opts ...ListOption) ([]servicecatalogv1beta1.ServiceBroker, error) {
...
type Merger func(newObj, oldObj *servicecatalogv1beta1.ServiceBroker) *servicecatalogv1beta1.ServiceBroker
...
func (core *coreClient) Upsert(namespace string, newObj *servicecatalogv1beta1.ServiceBroker, merge Merger) (*servicecatalogv1beta1.ServiceBroker, error) {
...
func (core *coreClient) WaitFor(ctx context.Context, namespace string, name string, interval time.Duration, condition Predicate) (*servicecatalogv1beta1.ServiceBroker, error) {
...
type ConditionFuncE func(instance *servicecatalogv1beta1.ServiceBroker, apiErr error) (done bool, err error)
...
func (core *coreClient) WaitForE(ctx context.Context, namespace string, name string, interval time.Duration, condition ConditionFuncE) (instance *servicecatalogv1beta1.ServiceBroker, err error) {
	var done bool
...
func ConditionDeleted(_ *servicecatalogv1beta1.ServiceBroker, apiErr error) (bool, error) {
	if apiErr != nil {
...
func wrapPredicate(condition Predicate) ConditionFuncE {
	return func(obj *servicecatalogv1beta1.ServiceBroker, err error) (bool, error) {
		if err != nil {
			return true, err
		}
