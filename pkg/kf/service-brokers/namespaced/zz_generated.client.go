...
// Predicate is a boolean function for a v1beta1.ServiceBroker.
type Predicate func(*v1beta1.ServiceBroker) bool

// Mutator is a function that changes v1beta1.ServiceBroker.
type Mutator func(*v1beta1.ServiceBroker) error
...
func DiffWrapper(w io.Writer, mutator Mutator) Mutator {
	return func(mutable *v1beta1.ServiceBroker) error {
...
// FormatDiff creates a diff between two v1beta1.ServiceBrokers and writes it to the given
// writer.
func FormatDiff(w io.Writer, leftName, rightName string, left, right *v1beta1.ServiceBroker) {
	...
	default:
		fmt.Fprintf(w, "ServiceBroker Diff (-%s +%s):\n", leftName, rightName)
...
// List represents a collection of v1beta1.ServiceBroker.
type List []v1beta1.ServiceBroker
...
func ExtractConditions(obj *v1beta1.ServiceBroker) (extracted []apis.Condition) {
...
// Client is the interface for interacting with v1beta1.ServiceBroker types as ServiceBroker CF style objects.
type Client interface {
	Create(namespace string, obj *v1beta1.ServiceBroker, opts ...CreateOption) (*v1beta1.ServiceBroker, error)
	Update(namespace string, obj *v1beta1.ServiceBroker, opts ...UpdateOption) (*v1beta1.ServiceBroker, error)
	Transform(namespace string, name string, transformer Mutator) (*v1beta1.ServiceBroker, error)
	Get(namespace string, name string, opts ...GetOption) (*v1beta1.ServiceBroker, error)
	Delete(namespace string, name string, opts ...DeleteOption) error
	List(namespace string, opts ...ListOption) ([]v1beta1.ServiceBroker, error)
	Upsert(namespace string, newObj *v1beta1.ServiceBroker, merge Merger) (*v1beta1.ServiceBroker, error)
	WaitFor(ctx context.Context, namespace string, name string, interval time.Duration, condition Predicate) (*v1beta1.ServiceBroker, error)
	WaitForE(ctx context.Context, namespace string, name string, interval time.Duration, condition ConditionFuncE) (*v1beta1.ServiceBroker, error)

	// Utility functions
	WaitForDeletion(ctx context.Context, namespace string, name string, interval time.Duration) (*v1beta1.ServiceBroker, error)
	WaitForConditionReadyTrue(ctx context.Context, namespace string, name string, interval time.Duration) (*v1beta1.ServiceBroker, error)
...
type coreClient struct {
	kclient      cv1beta1.ServiceBrokersGetter
	upsertMutate Mutator
}

func (core *coreClient) preprocessUpsert(obj *v1beta1.ServiceBroker) error {
...
// Create inserts the given v1beta1.ServiceBroker into the cluster.
// The value to be inserted will be preprocessed and validated before being sent.
func (core *coreClient) Create(namespace string, obj *v1beta1.ServiceBroker, opts ...CreateOption) (*v1beta1.ServiceBroker, error) {
	if err := core.preprocessUpsert(obj); err != nil {
		return nil, err
	}

	return core.kclient.ServiceBrokers(namespace).Create(obj)
}

// Update replaces the existing object in the cluster with the new one.
// The value to be inserted will be preprocessed and validated before being sent.
func (core *coreClient) Update(namespace string, obj *v1beta1.ServiceBroker, opts ...UpdateOption) (*v1beta1.ServiceBroker, error) {
	if err := core.preprocessUpsert(obj); err != nil {
		return nil, err
	}

	return core.kclient.ServiceBrokers(namespace).Update(obj)
}
...
// Update calls.
func (core *coreClient) Transform(namespace string, name string, mutator Mutator) (*v1beta1.ServiceBroker, error) {
...
func (core *coreClient) Get(namespace string, name string, opts ...GetOption) (*v1beta1.ServiceBroker, error) {
	res, err := core.kclient.ServiceBrokers(namespace).Get(name, metav1.GetOptions{})
	if err != nil {
		return nil, fmt.Errorf("couldn't get the ServiceBroker with the name %q: %v", name, err)
	}
...
func (core *coreClient) Delete(namespace string, name string, opts ...DeleteOption) error {
	...
	if err := core.kclient.ServiceBrokers(namespace).Delete(name, cfg.ToDeleteOptions()); err != nil {
		return fmt.Errorf("couldn't delete the ServiceBroker with the name %q: %v", name, err)
	}
...
func (core *coreClient) List(namespace string, opts ...ListOption) ([]v1beta1.ServiceBroker, error) {
	cfg := ListOptionDefaults().Extend(opts).toConfig()

	res, err := core.kclient.ServiceBrokers(namespace).List(cfg.ToListOptions())
	if err != nil {
		return nil, fmt.Errorf("couldn't list ServiceBrokers: %v", err)
	}
...
type Merger func(newObj, oldObj *v1beta1.ServiceBroker) *v1beta1.ServiceBroker
...
func (core *coreClient) Upsert(namespace string, newObj *v1beta1.ServiceBroker, merge Merger) (*v1beta1.ServiceBroker, error) {
...
func (core *coreClient) WaitFor(ctx context.Context, namespace string, name string, interval time.Duration, condition Predicate) (*v1beta1.ServiceBroker, error) {
...
type ConditionFuncE func(instance *v1beta1.ServiceBroker, apiErr error) (done bool, err error)
...
func (core *coreClient) WaitForE(ctx context.Context, namespace string, name string, interval time.Duration, condition ConditionFuncE) (instance *v1beta1.ServiceBroker, err error) {
	var done bool
	tick := time.Tick(interval)

	for {
		instance, err = core.kclient.ServiceBrokers(namespace).Get(name, metav1.GetOptions{})
		...
		case <-ctx.Done():
			return nil, errors.New("waiting for ServiceBroker timed out")
		}
	}
}
...
func ConditionDeleted(_ *v1beta1.ServiceBroker, apiErr error) (bool, error) {
	if apiErr != nil {
...
func wrapPredicate(condition Predicate) ConditionFuncE {
	return func(obj *v1beta1.ServiceBroker, err error) (bool, error) {
		if err != nil {
			return true, err
		}
...
func (core *coreClient) WaitForDeletion(ctx context.Context, namespace string, name string, interval time.Duration) (instance *v1beta1.ServiceBroker, err error) {
	return core.WaitForE(ctx, namespace, name, interval, ConditionDeleted)
}

func checkConditionTrue(obj *v1beta1.ServiceBroker, err error, condition apis.ConditionType) (bool, error) {
	if err != nil {
		return true, err
	}
...
func ConditionReadyTrue(obj *v1beta1.ServiceBroker, err error) (bool, error) {
...
func (core *coreClient) WaitForConditionReadyTrue(ctx context.Context, namespace string, name string, interval time.Duration) (instance *v1beta1.ServiceBroker, err error) {
