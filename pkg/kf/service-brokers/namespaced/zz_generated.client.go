...
// Predicate is a boolean function for a v1alpha1.ServiceBroker.
type Predicate func(*v1alpha1.ServiceBroker) bool

// Mutator is a function that changes v1alpha1.ServiceBroker.
type Mutator func(*v1alpha1.ServiceBroker) error
...
func ObservedGenerationMatchesGeneration(obj *v1alpha1.ServiceBroker) bool {
...
func ExtractConditions(obj *v1alpha1.ServiceBroker) (extracted []apis.Condition) {
...
// Client is the interface for interacting with v1alpha1.ServiceBroker types as ServiceBroker CF style objects.
type Client interface {
	Create(ctx context.Context, namespace string, obj *v1alpha1.ServiceBroker) (*v1alpha1.ServiceBroker, error)
	Transform(ctx context.Context, namespace string, name string, transformer Mutator) (*v1alpha1.ServiceBroker, error)
	Get(ctx context.Context, namespace string, name string) (*v1alpha1.ServiceBroker, error)
	Delete(ctx context.Context, namespace string, name string) error
	List(ctx context.Context, namespace string) ([]v1alpha1.ServiceBroker, error)
	Upsert(ctx context.Context, namespace string, newObj *v1alpha1.ServiceBroker, merge Merger) (*v1alpha1.ServiceBroker, error)
	WaitFor(ctx context.Context, namespace string, name string, interval time.Duration, condition Predicate) (*v1alpha1.ServiceBroker, error)

	// Utility functions
	WaitForDeletion(ctx context.Context, namespace string, name string, interval time.Duration) (*v1alpha1.ServiceBroker, error)
	WaitForConditionReadyTrue(ctx context.Context, namespace string, name string, interval time.Duration) (*v1alpha1.ServiceBroker, error)
...
type coreClient struct {
	kclient cv1alpha1.ServiceBrokersGetter
}

// Create inserts the given v1alpha1.ServiceBroker into the cluster.
// The value to be inserted will be preprocessed and validated before being sent.
func (core *coreClient) Create(ctx context.Context, namespace string, obj *v1alpha1.ServiceBroker) (*v1alpha1.ServiceBroker, error) {
	return core.kclient.ServiceBrokers(namespace).Create(ctx, obj, metav1.CreateOptions{})
}
...
// conflict.
func (core *coreClient) Transform(ctx context.Context, namespace string, name string, mutator Mutator) (*v1alpha1.ServiceBroker, error) {
	for {
		...
		result, err := core.kclient.ServiceBrokers(namespace).Update(ctx, obj, metav1.UpdateOptions{})
...
func (core *coreClient) Get(ctx context.Context, namespace string, name string) (*v1alpha1.ServiceBroker, error) {
	res, err := core.kclient.ServiceBrokers(namespace).Get(ctx, name, metav1.GetOptions{})
	if err != nil {
		return nil, err
	}
...
func (core *coreClient) Delete(ctx context.Context, namespace string, name string) error {
	...
	if err := core.kclient.ServiceBrokers(namespace).Delete(ctx, name, metav1.DeleteOptions{PropagationPolicy: &foreground}); err != nil {
...
func (core *coreClient) List(ctx context.Context, namespace string) ([]v1alpha1.ServiceBroker, error) {
	res, err := core.kclient.ServiceBrokers(namespace).List(ctx, metav1.ListOptions{})
	if err != nil {
...
type Merger func(newObj, oldObj *v1alpha1.ServiceBroker) *v1alpha1.ServiceBroker
...
func (core *coreClient) Upsert(ctx context.Context, namespace string, newObj *v1alpha1.ServiceBroker, merge Merger) (*v1alpha1.ServiceBroker, error) {
	for ctx.Err() == nil {
		// kclient must be used so the error code can be validated by apierrors
		oldObj, err := core.kclient.ServiceBrokers(namespace).Get(ctx, newObj.Name, metav1.GetOptions{})
		...
		updated, err := core.kclient.ServiceBrokers(namespace).Update(ctx, merge(newObj, oldObj), metav1.UpdateOptions{})
		switch {
...
func (core *coreClient) WaitFor(ctx context.Context, namespace string, name string, interval time.Duration, condition Predicate) (*v1alpha1.ServiceBroker, error) {
...
//
// The function polls infinitely if no timeout is supplied.
func (core *coreClient) waitForE(ctx context.Context, namespace string, name string, interval time.Duration, condition ConditionFuncE) (instance *v1alpha1.ServiceBroker, err error) {
	var done bool
...
func (core *coreClient) WaitForDeletion(ctx context.Context, namespace string, name string, interval time.Duration) (instance *v1alpha1.ServiceBroker, err error) {
...
func (core *coreClient) WaitForConditionReadyTrue(ctx context.Context, namespace string, name string, interval time.Duration) (instance *v1alpha1.ServiceBroker, err error) {
