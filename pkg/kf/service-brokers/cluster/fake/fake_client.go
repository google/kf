...
// Source: github.com/google/kf/pkg/kf/service-brokers/cluster/fake (interfaces: Client)
...
import (
	...
	cluster "github.com/google/kf/pkg/kf/service-brokers/cluster"
...
func (m *FakeClient) Create(arg0 *v1beta1.ClusterServiceBroker, arg1 ...cluster.CreateOption) (*v1beta1.ClusterServiceBroker, error) {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(*v1beta1.ClusterServiceBroker)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *FakeClient) Delete(arg0 string, arg1 ...cluster.DeleteOption) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0}
	for _, a := range arg1 {
		varargs = append(varargs, a)
...
func (m *FakeClient) Get(arg0 string, arg1 ...cluster.GetOption) (*v1beta1.ClusterServiceBroker, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0}
	for _, a := range arg1 {
		varargs = append(varargs, a)
...
func (m *FakeClient) List(arg0 ...cluster.ListOption) ([]v1beta1.ClusterServiceBroker, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{}
	for _, a := range arg0 {
		varargs = append(varargs, a)
...
func (m *FakeClient) Transform(arg0 string, arg1 cluster.Mutator) (*v1beta1.ClusterServiceBroker, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) Update(arg0 *v1beta1.ClusterServiceBroker, arg1 ...cluster.UpdateOption) (*v1beta1.ClusterServiceBroker, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0}
	for _, a := range arg1 {
		varargs = append(varargs, a)
...
func (m *FakeClient) Upsert(arg0 *v1beta1.ClusterServiceBroker, arg1 cluster.Merger) (*v1beta1.ClusterServiceBroker, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) WaitFor(arg0 context.Context, arg1 string, arg2 time.Duration, arg3 cluster.Predicate) (*v1beta1.ClusterServiceBroker, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) WaitForConditionReadyTrue(arg0 context.Context, arg1 string, arg2 time.Duration) (*v1beta1.ClusterServiceBroker, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) WaitForDeletion(arg0 context.Context, arg1 string, arg2 time.Duration) (*v1beta1.ClusterServiceBroker, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) WaitForE(arg0 context.Context, arg1 string, arg2 time.Duration, arg3 cluster.ConditionFuncE) (*v1beta1.ClusterServiceBroker, error) {
	m.ctrl.T.Helper()
