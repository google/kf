...
// Source: github.com/google/kf/v2/pkg/kf/networkpolicies/fake (interfaces: Client)
...
import (
	...
	networkpolicies "github.com/google/kf/v2/pkg/kf/networkpolicies"
...
func (m *FakeClient) Create(arg0 context.Context, arg1 string, arg2 *v1.NetworkPolicy) (*v1.NetworkPolicy, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) Get(arg0 context.Context, arg1, arg2 string) (*v1.NetworkPolicy, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) List(arg0 context.Context, arg1 string) ([]v1.NetworkPolicy, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) Transform(arg0 context.Context, arg1, arg2 string, arg3 networkpolicies.Mutator) (*v1.NetworkPolicy, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) Upsert(arg0 context.Context, arg1 string, arg2 *v1.NetworkPolicy, arg3 networkpolicies.Merger) (*v1.NetworkPolicy, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) WaitFor(arg0 context.Context, arg1, arg2 string, arg3 time.Duration, arg4 networkpolicies.Predicate) (*v1.NetworkPolicy, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) WaitForDeletion(arg0 context.Context, arg1, arg2 string, arg3 time.Duration) (*v1.NetworkPolicy, error) {
	m.ctrl.T.Helper()
