...
// Source: github.com/google/kf/v2/pkg/kf/serviceinstances/fake (interfaces: Client)
...
import (
	...
	serviceinstances "github.com/google/kf/v2/pkg/kf/serviceinstances"
)
...
func (m *FakeClient) Create(arg0 context.Context, arg1 string, arg2 *v1alpha1.ServiceInstance) (*v1alpha1.ServiceInstance, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", arg0, arg1, arg2)
	ret0, _ := ret[0].(*v1alpha1.ServiceInstance)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *FakeClient) Get(arg0 context.Context, arg1, arg2 string) (*v1alpha1.ServiceInstance, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) List(arg0 context.Context, arg1 string) ([]v1alpha1.ServiceInstance, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) Transform(arg0 context.Context, arg1, arg2 string, arg3 serviceinstances.Mutator) (*v1alpha1.ServiceInstance, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) Upsert(arg0 context.Context, arg1 string, arg2 *v1alpha1.ServiceInstance, arg3 serviceinstances.Merger) (*v1alpha1.ServiceInstance, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) WaitFor(arg0 context.Context, arg1, arg2 string, arg3 time.Duration, arg4 serviceinstances.Predicate) (*v1alpha1.ServiceInstance, error) {
	m.ctrl.T.Helper()
...
// WaitForConditionParamsSecretReadyTrue mocks base method.
func (m *FakeClient) WaitForConditionParamsSecretReadyTrue(arg0 context.Context, arg1, arg2 string, arg3 time.Duration) (*v1alpha1.ServiceInstance, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WaitForConditionParamsSecretReadyTrue", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(*v1alpha1.ServiceInstance)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// WaitForConditionParamsSecretReadyTrue indicates an expected call of WaitForConditionParamsSecretReadyTrue.
func (mr *FakeClientMockRecorder) WaitForConditionParamsSecretReadyTrue(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WaitForConditionParamsSecretReadyTrue", reflect.TypeOf((*FakeClient)(nil).WaitForConditionParamsSecretReadyTrue), arg0, arg1, arg2, arg3)
}

// WaitForConditionReadyTrue mocks base method.
func (m *FakeClient) WaitForConditionReadyTrue(arg0 context.Context, arg1, arg2 string, arg3 time.Duration) (*v1alpha1.ServiceInstance, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) WaitForDeletion(arg0 context.Context, arg1, arg2 string, arg3 time.Duration) (*v1alpha1.ServiceInstance, error) {
	m.ctrl.T.Helper()
