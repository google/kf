...
// Source: github.com/GoogleCloudPlatform/kf/pkg/kf/quotas/fake (interfaces: Client)

// Package fake is a generated GoMock package.
package fake

import (
	quotas "github.com/GoogleCloudPlatform/kf/pkg/kf/quotas"
...
func (m *FakeClient) Create(arg0 string, arg1 *v1.ResourceQuota, arg2 ...quotas.CreateOption) (*v1.ResourceQuota, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) Delete(arg0, arg1 string, arg2 ...quotas.DeleteOption) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *FakeClient) Get(arg0, arg1 string, arg2 ...quotas.GetOption) (*v1.ResourceQuota, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *FakeClient) List(arg0 string, arg1 ...quotas.ListOption) ([]v1.ResourceQuota, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) Transform(arg0, arg1 string, arg2 quotas.Mutator) error {
	m.ctrl.T.Helper()
...
func (m *FakeClient) Update(arg0 string, arg1 *v1.ResourceQuota, arg2 ...quotas.UpdateOption) (*v1.ResourceQuota, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *FakeClient) Upsert(arg0 string, arg1 *v1.ResourceQuota, arg2 quotas.Merger) (*v1.ResourceQuota, error) {
	m.ctrl.T.Helper()
