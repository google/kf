...
var (
	ConditionReady = apis.ConditionType(v1alpha1.SpaceConditionReady)
)
...
func (core *coreClient) Create(ctx context.Context, obj *v1alpha1.Space) (*v1alpha1.Space, error) {
	return core.kclient.Spaces().Create(ctx, obj, metav1.CreateOptions{})
}
...
// conflict.
func (core *coreClient) Transform(ctx context.Context, name string, mutator Mutator) (*v1alpha1.Space, error) {
	for {
		...
		result, err := core.kclient.Spaces().Update(ctx, obj, metav1.UpdateOptions{})
...
func (core *coreClient) Get(ctx context.Context, name string) (*v1alpha1.Space, error) {
	res, err := core.kclient.Spaces().Get(ctx, name, metav1.GetOptions{})
	if err != nil {
		return nil, err
	}
...
func (core *coreClient) Delete(ctx context.Context, name string) error {
	...
	if err := core.kclient.Spaces().Delete(ctx, name, metav1.DeleteOptions{PropagationPolicy: &foreground}); err != nil {
...
func (core *coreClient) List(ctx context.Context) ([]v1alpha1.Space, error) {
	res, err := core.kclient.Spaces().List(ctx, metav1.ListOptions{})
	if err != nil {
...
func (core *coreClient) Upsert(ctx context.Context, newObj *v1alpha1.Space, merge Merger) (*v1alpha1.Space, error) {
	for ctx.Err() == nil {
		// kclient must be used so the error code can be validated by apierrors
		oldObj, err := core.kclient.Spaces().Get(ctx, newObj.Name, metav1.GetOptions{})
		...
		updated, err := core.kclient.Spaces().Update(ctx, merge(newObj, oldObj), metav1.UpdateOptions{})
		switch {
...
func (core *coreClient) WaitForDeletion(ctx context.Context, name string, interval time.Duration) (instance *v1alpha1.Space, err error) {
...
func (core *coreClient) WaitForConditionReadyTrue(ctx context.Context, name string, interval time.Duration) (instance *v1alpha1.Space, err error) {
