...
// Source: github.com/google/kf/v2/pkg/kf/configmaps/fake (interfaces: Client)
...
import (
	...
	configmaps "github.com/google/kf/v2/pkg/kf/configmaps"
...
func (m *FakeClient) Create(arg0 context.Context, arg1 string, arg2 *v1.ConfigMap) (*v1.ConfigMap, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) Get(arg0 context.Context, arg1, arg2 string) (*v1.ConfigMap, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) List(arg0 context.Context, arg1 string) ([]v1.ConfigMap, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) Transform(arg0 context.Context, arg1, arg2 string, arg3 configmaps.Mutator) (*v1.ConfigMap, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) Upsert(arg0 context.Context, arg1 string, arg2 *v1.ConfigMap, arg3 configmaps.Merger) (*v1.ConfigMap, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) WaitFor(arg0 context.Context, arg1, arg2 string, arg3 time.Duration, arg4 configmaps.Predicate) (*v1.ConfigMap, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) WaitForDeletion(arg0 context.Context, arg1, arg2 string, arg3 time.Duration) (*v1.ConfigMap, error) {
	m.ctrl.T.Helper()
