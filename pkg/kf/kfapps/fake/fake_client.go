...
// Source: github.com/google/kf/pkg/kf/kfapps/fake (interfaces: Client)
...
import (
	...
	kfapps "github.com/google/kf/pkg/kf/kfapps"
	reflect "reflect"
)
...
func (m *FakeClient) Create(arg0 string, arg1 *v1alpha1.App, arg2 ...kfapps.CreateOption) (*v1alpha1.App, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) Delete(arg0, arg1 string, arg2 ...kfapps.DeleteOption) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *FakeClient) Get(arg0, arg1 string, arg2 ...kfapps.GetOption) (*v1alpha1.App, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *FakeClient) List(arg0 string, arg1 ...kfapps.ListOption) ([]v1alpha1.App, error) {
	m.ctrl.T.Helper()
...
func (m *FakeClient) Update(arg0 string, arg1 *v1alpha1.App, arg2 ...kfapps.UpdateOption) (*v1alpha1.App, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *FakeClient) Upsert(arg0 string, arg1 *v1alpha1.App, arg2 kfapps.Merger) (*v1alpha1.App, error) {
	m.ctrl.T.Helper()
