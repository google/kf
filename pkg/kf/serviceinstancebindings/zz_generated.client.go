...
var (
	ConditionReady = apis.ConditionType(v1alpha1.ServiceInstanceBindingConditionReady)
)

// Predicate is a boolean function for a v1alpha1.ServiceInstanceBinding.
type Predicate func(*v1alpha1.ServiceInstanceBinding) bool

// Mutator is a function that changes v1alpha1.ServiceInstanceBinding.
type Mutator func(*v1alpha1.ServiceInstanceBinding) error
...
func ObservedGenerationMatchesGeneration(obj *v1alpha1.ServiceInstanceBinding) bool {
...
func ExtractConditions(obj *v1alpha1.ServiceInstanceBinding) (extracted []apis.Condition) {
...
// Client is the interface for interacting with v1alpha1.ServiceInstanceBinding types as ServiceInstanceBinding CF style objects.
type Client interface {
	Create(ctx context.Context, namespace string, obj *v1alpha1.ServiceInstanceBinding) (*v1alpha1.ServiceInstanceBinding, error)
	Transform(ctx context.Context, namespace string, name string, transformer Mutator) (*v1alpha1.ServiceInstanceBinding, error)
	Get(ctx context.Context, namespace string, name string) (*v1alpha1.ServiceInstanceBinding, error)
	Delete(ctx context.Context, namespace string, name string) error
	List(ctx context.Context, namespace string) ([]v1alpha1.ServiceInstanceBinding, error)
	Upsert(ctx context.Context, namespace string, newObj *v1alpha1.ServiceInstanceBinding, merge Merger) (*v1alpha1.ServiceInstanceBinding, error)
	WaitFor(ctx context.Context, namespace string, name string, interval time.Duration, condition Predicate) (*v1alpha1.ServiceInstanceBinding, error)

	// Utility functions
	WaitForDeletion(ctx context.Context, namespace string, name string, interval time.Duration) (*v1alpha1.ServiceInstanceBinding, error)
	WaitForConditionReadyTrue(ctx context.Context, namespace string, name string, interval time.Duration) (*v1alpha1.ServiceInstanceBinding, error)
...
type coreClient struct {
	kclient cv1alpha1.ServiceInstanceBindingsGetter
}

// Create inserts the given v1alpha1.ServiceInstanceBinding into the cluster.
// The value to be inserted will be preprocessed and validated before being sent.
func (core *coreClient) Create(ctx context.Context, namespace string, obj *v1alpha1.ServiceInstanceBinding) (*v1alpha1.ServiceInstanceBinding, error) {
	return core.kclient.ServiceInstanceBindings(namespace).Create(ctx, obj, metav1.CreateOptions{})
}
...
// conflict.
func (core *coreClient) Transform(ctx context.Context, namespace string, name string, mutator Mutator) (*v1alpha1.ServiceInstanceBinding, error) {
	for {
		...
		result, err := core.kclient.ServiceInstanceBindings(namespace).Update(ctx, obj, metav1.UpdateOptions{})
...
func (core *coreClient) Get(ctx context.Context, namespace string, name string) (*v1alpha1.ServiceInstanceBinding, error) {
	res, err := core.kclient.ServiceInstanceBindings(namespace).Get(ctx, name, metav1.GetOptions{})
	if err != nil {
		return nil, err
	}
...
func (core *coreClient) Delete(ctx context.Context, namespace string, name string) error {
	...
	if err := core.kclient.ServiceInstanceBindings(namespace).Delete(ctx, name, metav1.DeleteOptions{PropagationPolicy: &foreground}); err != nil {
		return fmt.Errorf("couldn't delete the ServiceInstanceBinding with the name %q: %v", name, err)
	}
...
func (core *coreClient) List(ctx context.Context, namespace string) ([]v1alpha1.ServiceInstanceBinding, error) {
	res, err := core.kclient.ServiceInstanceBindings(namespace).List(ctx, metav1.ListOptions{})
	if err != nil {
		return nil, fmt.Errorf("couldn't list ServiceInstanceBindings: %v", err)
	}
...
type Merger func(newObj, oldObj *v1alpha1.ServiceInstanceBinding) *v1alpha1.ServiceInstanceBinding
...
func (core *coreClient) Upsert(ctx context.Context, namespace string, newObj *v1alpha1.ServiceInstanceBinding, merge Merger) (*v1alpha1.ServiceInstanceBinding, error) {
	for ctx.Err() == nil {
		// kclient must be used so the error code can be validated by apierrors
		oldObj, err := core.kclient.ServiceInstanceBindings(namespace).Get(ctx, newObj.Name, metav1.GetOptions{})
		...
		updated, err := core.kclient.ServiceInstanceBindings(namespace).Update(ctx, merge(newObj, oldObj), metav1.UpdateOptions{})
		switch {
...
func (core *coreClient) WaitFor(ctx context.Context, namespace string, name string, interval time.Duration, condition Predicate) (*v1alpha1.ServiceInstanceBinding, error) {
...
//
// The function polls infinitely if no timeout is supplied.
func (core *coreClient) waitForE(ctx context.Context, namespace string, name string, interval time.Duration, condition ConditionFuncE) (instance *v1alpha1.ServiceInstanceBinding, err error) {
	var done bool
	...
	for {
		...
		case <-ctx.Done():
			return nil, errors.New("waiting for ServiceInstanceBinding timed out")
		}
	}
}
...
func (core *coreClient) WaitForDeletion(ctx context.Context, namespace string, name string, interval time.Duration) (instance *v1alpha1.ServiceInstanceBinding, err error) {
...
func (core *coreClient) WaitForConditionReadyTrue(ctx context.Context, namespace string, name string, interval time.Duration) (instance *v1alpha1.ServiceInstanceBinding, err error) {
