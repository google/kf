...
func (c *serviceInstances) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ServiceInstance, err error) {
...
func (c *serviceInstances) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ServiceInstanceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ServiceInstanceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("serviceinstances").
...
func (c *serviceInstances) Create(ctx context.Context, serviceInstance *v1alpha1.ServiceInstance, opts v1.CreateOptions) (result *v1alpha1.ServiceInstance, err error) {
	result = &v1alpha1.ServiceInstance{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("serviceinstances").
...
func (c *serviceInstances) Update(ctx context.Context, serviceInstance *v1alpha1.ServiceInstance, opts v1.UpdateOptions) (result *v1alpha1.ServiceInstance, err error) {
	result = &v1alpha1.ServiceInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("serviceinstances").
...
func (c *serviceInstances) UpdateStatus(ctx context.Context, serviceInstance *v1alpha1.ServiceInstance, opts v1.UpdateOptions) (result *v1alpha1.ServiceInstance, err error) {
	result = &v1alpha1.ServiceInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("serviceinstances").
...
func (c *serviceInstances) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ServiceInstance, err error) {
	result = &v1alpha1.ServiceInstance{}
