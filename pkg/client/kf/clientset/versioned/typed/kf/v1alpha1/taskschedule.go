...
// TaskSchedulesGetter has a method to return a TaskScheduleInterface.
...
// taskSchedules implements TaskScheduleInterface
type taskSchedules struct {
	client rest.Interface
	ns     string
}

// newTaskSchedules returns a TaskSchedules
func newTaskSchedules(c *KfV1alpha1Client, namespace string) *taskSchedules {
...
func (c *taskSchedules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TaskSchedule, err error) {
	result = &v1alpha1.TaskSchedule{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *taskSchedules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TaskScheduleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TaskScheduleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("taskschedules").
...
func (c *taskSchedules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *taskSchedules) Create(ctx context.Context, taskSchedule *v1alpha1.TaskSchedule, opts v1.CreateOptions) (result *v1alpha1.TaskSchedule, err error) {
	result = &v1alpha1.TaskSchedule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("taskschedules").
...
func (c *taskSchedules) Update(ctx context.Context, taskSchedule *v1alpha1.TaskSchedule, opts v1.UpdateOptions) (result *v1alpha1.TaskSchedule, err error) {
	result = &v1alpha1.TaskSchedule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("taskschedules").
...
func (c *taskSchedules) UpdateStatus(ctx context.Context, taskSchedule *v1alpha1.TaskSchedule, opts v1.UpdateOptions) (result *v1alpha1.TaskSchedule, err error) {
	result = &v1alpha1.TaskSchedule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("taskschedules").
...
func (c *taskSchedules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *taskSchedules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *taskSchedules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TaskSchedule, err error) {
	result = &v1alpha1.TaskSchedule{}
