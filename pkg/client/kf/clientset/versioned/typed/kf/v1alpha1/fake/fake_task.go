...
var tasksResource = schema.GroupVersionResource{Group: "kf.dev", Version: "v1alpha1", Resource: "tasks"}

var tasksKind = schema.GroupVersionKind{Group: "kf.dev", Version: "v1alpha1", Kind: "Task"}
