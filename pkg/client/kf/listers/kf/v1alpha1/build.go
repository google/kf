...
type BuildLister interface {
	...
	List(selector labels.Selector) (ret []*kfv1alpha1.Build, err error)
...
type buildLister struct {
	listers.ResourceIndexer[*kfv1alpha1.Build]
}

// NewBuildLister returns a new BuildLister.
func NewBuildLister(indexer cache.Indexer) BuildLister {
	return &buildLister{listers.New[*kfv1alpha1.Build](indexer, kfv1alpha1.Resource("build"))}
}

// Builds returns an object that can list and get Builds.
func (s *buildLister) Builds(namespace string) BuildNamespaceLister {
	return buildNamespaceLister{listers.NewNamespaced[*kfv1alpha1.Build](s.ResourceIndexer, namespace)}
}
...
type BuildNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*kfv1alpha1.Build, error)
