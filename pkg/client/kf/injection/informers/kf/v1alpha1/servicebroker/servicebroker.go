...
func Get(ctx context.Context) v1alpha1.ServiceBrokerInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/google/kf/v2/pkg/client/kf/informers/externalversions/kf/v1alpha1.ServiceBrokerInformer from context.")
	}
