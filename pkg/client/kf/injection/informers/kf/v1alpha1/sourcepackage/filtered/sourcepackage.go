...
func Get(ctx context.Context, selector string) v1alpha1.SourcePackageInformer {
	untyped := ctx.Value(Key{Selector: selector})
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/google/kf/v2/pkg/client/kf/informers/externalversions/kf/v1alpha1.SourcePackageInformer with selector %s from context.", selector)
	}
