...
import (
	...
	fake "github.com/google/kf/v2/pkg/client/kube-aggregator/clientset/versioned/fake"
...
func Get(ctx context.Context) *fake.Clientset {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/google/kf/v2/pkg/client/kube-aggregator/clientset/versioned/fake.Clientset from context.")
	}
