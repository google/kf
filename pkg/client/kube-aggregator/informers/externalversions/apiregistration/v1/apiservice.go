...
import (
	...
	internalinterfaces "github.com/google/kf/v2/pkg/client/kube-aggregator/informers/externalversions/internalinterfaces"
...
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewAPIServiceInformerWithOptions(client versioned.Interface, options internalinterfaces.InformerOptions) cache.SharedIndexInformer {
