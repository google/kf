...
func Get(ctx context.Context, selector string) v1.IngressInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/google/kf/v2/pkg/client/kube/informers/externalversions/networking/v1.IngressInformer with selector %s from context.", selector)
	}
