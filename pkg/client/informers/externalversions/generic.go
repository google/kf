...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("kfspaces"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Kf().V1alpha1().KfSpaces().Informer()}, nil
