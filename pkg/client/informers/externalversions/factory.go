...
import (
	...
	kf "github.com/GoogleCloudPlatform/kf/pkg/client/informers/externalversions/kf"
...
func (f *sharedInformerFactory) Kf() kf.Interface {
	return kf.New(f, f.namespace, f.tweakListOptions)
}
