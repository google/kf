...
var routesResource = schema.GroupVersionResource{Group: "kf.dev", Version: "v1alpha1", Resource: "routes"}

var routesKind = schema.GroupVersionKind{Group: "kf.dev", Version: "v1alpha1", Kind: "Route"}
