...
source ./hack/generate-lifecycle-artifacts.sh
...
# install operator
kf_latest_version=$(ls ${temp_dir}/operator/cmd/manager/kodata/kf -1 --sort=version | tail -n 1)
kf_folder="${temp_dir}/operator/cmd/manager/kodata/kf/${kf_latest_version}"
